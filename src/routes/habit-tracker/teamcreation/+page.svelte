	...
	{#if form}
		...
		{#if form.success}
			<div class="flex flex-col gap-2">
				...
				<a class="text-blue-500 text-center underline" href="/habit-tracker/dashboard"
		...
		<form method="POST" action="?/addTeam " use:enhance>
			<div class="grid w-full items-center gap-4">
				...
				<p class="text-gray-500 mb-5">
					If you choose your team to be private , others will not be able to search for your team
					only you can invite them
				</p>
			</div>
